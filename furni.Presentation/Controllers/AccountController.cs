...
namespace furni.Presentation.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(UserManager<AppUser> userManager,
            SignInManager<AppUser> signInManager, ApplicationDbContext context, IHubContext<OrderHub> orderHubContext)
        {
            _context = context;
        ...
        public async Task<IActionResult> Detail(int id)
        {
            ...
            var checkOrderUser = _context.Order
        ...
        public async Task<IActionResult> GetAddresses()
        {
            ...
            var addresses = await _context.Address.Where(a => a.AppUserId == userId && !a.IsDeleted).ToListAsync();
            return Ok(addresses);
        }
        ...
        {
            if (_context.Color == null) return Problem("Entity set 'AppDbContext.Color'  is null.");

            var color = await _context.Address.FindAsync(id);
            if (color != null) color.IsDeleted = true;
        ...
        public async Task<IActionResult> AddAddress([FromBody] AddressViewModel addressViewModel)
        {
            try
            {
                ...
                {
                    var defaultAddress = _context.Address.Where(a => a.IsDefault).FirstOrDefault();
        ...
        public async Task<IActionResult> EditAddress(int id, [FromBody] AddressViewModel addressViewModel)
        {
            try
            {
                ...
                if (addressViewModel.IsDefault)
                {
                    var currentDefaultAddress = await _context.Address.FirstOrDefaultAsync(a => a.IsDefault);
